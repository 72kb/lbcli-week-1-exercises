...
# WRITE YOUR SOLUTION BELOW:
VERIFY_RESULT=$(bitcoin-cli -rpcwallet=btrustwallet verifymessage $LEGACY_ADDR "$SIGNATURE" "$SECRET_MESSAGE")
...
# WRITE YOUR SOLUTION BELOW:
INTERNAL_KEY=$(echo $ADDR_INFO | jq -r .pubkeys[0])
...
# WRITE YOUR SOLUTION BELOW:
DERIVED_ADDR_RAW=$(bitcoin-cli deriveaddresses "$TAPROOT_DESCRIPTOR"
